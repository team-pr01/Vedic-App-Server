...
router.post("/participate/:id", (0, auth_1.default)(auth_constannts_1.UserRole.user, auth_constannts_1.UserRole.temple, auth_constannts_1.UserRole.moderator, auth_constannts_1.UserRole["super-admin"], auth_constannts_1.UserRole.admin), quiz_controller_1.QuizController.participateQuiz);
