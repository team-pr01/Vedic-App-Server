...
router.post("/donate", multer_config_1.multerUpload.single("file"), (0, auth_1.default)(auth_constannts_1.UserRole.admin, auth_constannts_1.UserRole.moderator, auth_constannts_1.UserRole["super-admin"], auth_constannts_1.UserRole.user), (0, authorizeRoute_1.default)(), donation_controller_1.DonationController.donate);
